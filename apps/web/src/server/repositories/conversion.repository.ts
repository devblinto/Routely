...
import type { Conversion, Variant } from "@/generated/prisma/client";
...
/**
 * Conversions per arm. Because the table holds at most one row per assignment, this count is
 * already de-duplicated and can be divided by the assignment count to give a conversion rate.
 */
